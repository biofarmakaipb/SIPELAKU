...
Route::group(['middleware' => 'auth:api'], function () {
    ...
    Route::patch('pengajuandanaproyek/edit','TransaksiProyekController@editPengajuanDana');
    ...
    Route::post('pengajuandanaproyek/tambahitem','TransaksiProyekController@tambahItemPengajuanDana');
...
Route::group(['middleware' => 'guest:api'], function () {
    ...
    Route::get('download/userguide','DashboardController@downloadUserGuide');
});
